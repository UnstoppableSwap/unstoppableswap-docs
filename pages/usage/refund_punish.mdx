...
If the _Swap Provider_ has not been able to redeem the Bitcoin within 24 hours (144 Bitcoin blocks) from the start of the swap, the swap will be cancelled.
