...
After pressing the <img src="/start*swap_button.png" style={{
    height: "1lh",
    display: "inline-block",
    // center vertically
    verticalAlign: "middle",
}}/> button, you'll be displayed with an offer by the \_Swap Provider*. This includes:
...
## Step 4: Waiting for the swap to complete
